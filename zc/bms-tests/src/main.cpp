...
//   Serial.begin(9600); // Assuming computer will be connected to serial port at 115200 bauds
//   Serial.print("Setup...");
...
//   ETH.begin();
//   ETH.config(IPAddress(192, 168, 0, 5),IPAddress(0, 0, 0, 0),IPAddress(255, 255, 255, 0));
// }
