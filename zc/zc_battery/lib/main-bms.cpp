...
// Olimax U1TXD (TX1) -> BMS TX
// Olimax U1RXD (RX1) -> BMS RX
...
//   float packCurrent = bms.get.packCurrent;
//   float packSOC = bms.get.packSOC;

//   if (packVoltage > biggestVoltage) {
//     biggestVoltage = packVoltage;
//   }

//   if (packCurrent > biggestCurrent) {
//     biggestCurrent = packCurrent;
//   }

//   if (packSOC > biggestSOC) {
//     biggestSOC = packSOC;
//   }

//   if (duration > biggestDelay) {
//     biggestDelay = duration;
//   }

//   Serial.println("Basic BMS Data:              " + (String)packVoltage + "V " + (String)packCurrent + "I " + (String)
//   packSOC + "\% " + " Duration: " + (String)duration + "ms");
// }